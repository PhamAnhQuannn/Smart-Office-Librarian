...
- Key Output:
  ...
  - Step 75: scoped regression gate replay passed on 2026-03-15 and checkpoint pushed to origin/main (replay validation #6)
...
- Commit hash: pending replay validation #6 checkpoint commit
