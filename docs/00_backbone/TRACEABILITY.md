...
| NFR-4 | Security and Privacy | 🟨 | backend/app/core/security.py; backend/app/api/v1/dependencies/auth.py; backend/app/core/logging.py; backend/app/main.py; backend/app/connectors/github/client.py; backend/app/api/v1/routes/admin_routes.py (Step 76 evaluation: AES-256 at-rest, log redaction, least-privilege token enforcement, 14-day retention tagging, and source/threshold audit logging are implemented. Remaining gaps: TLS/transit enforcement evidence, 90-day data-retention purge (NFR-4.5), role/permission change audit logging (NFR-4.6 + TESTING 11.9).) | backend/tests/unit/test_api/test_auth.py; backend/tests/integration/test_auth_flow.py; backend/tests/unit/test_core/test_secrets_encryption.py; backend/tests/unit/test_core/test_logging_hygiene.py; backend/tests/unit/test_connectors/test_github_client.py; backend/tests/unit/domain/test_ingest_service.py; backend/tests/unit/test_api/test_admin_routes.py; backend/tests/integration/test_audit_logging.py (evidence: Step 75 scoped gate -> 4 unit + 2 integration passed, commit 88f8bc4. Missing: TLS/transit evidence; data-retention purge tests (NFR-4.5); role change audit log test (TESTING 11.9).) | Step 76 |
| NFR-4 | Security and Privacy | 🟨 | backend/app/core/security.py; backend/app/api/v1/dependencies/auth.py; backend/app/core/logging.py; backend/app/main.py; backend/app/connectors/github/client.py; backend/app/api/v1/routes/admin_routes.py (Step 78 gate: AES-256 at-rest, log redaction, least-privilege token enforcement, 14-day retention tagging, source/threshold audit logging, and role/permission change audit logging are implemented. Remaining gaps: TLS/transit enforcement evidence (NFR-4.1), 90-day data-retention purge (NFR-4.5).) | backend/tests/unit/test_api/test_auth.py; backend/tests/integration/test_auth_flow.py; backend/tests/unit/test_core/test_secrets_encryption.py; backend/tests/unit/test_core/test_logging_hygiene.py; backend/tests/unit/test_connectors/test_github_client.py; backend/tests/unit/domain/test_ingest_service.py; backend/tests/unit/test_api/test_admin_routes.py; backend/tests/integration/test_audit_logging.py (evidence: Step 78 scoped gate -> 6 unit + 3 integration passed, commit 6ff024a. Missing: TLS/transit evidence (NFR-4.1); data-retention purge tests (NFR-4.5).) | Step 78 |
