...
import { Zap, Database, HardDrive, TrendingUp, AlertCircle } from "lucide-react";
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-mono text-xs text-slate-700 truncate ml-4 max-w-[160px]">{workspace.id}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500">Namespace</span>
              <span className="font-mono text-xs text-slate-700">{workspace.slug}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500">Monthly cap</span>
              <span className="font-semibold text-slate-800">{workspace.limits.monthly_query_cap.toLocaleString()} queries</span>
            </div>
          </div>
        </div>
      </div>
